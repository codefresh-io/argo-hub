...
* ENABLE_AWS_REGION_VALIDATION (optional) - Option enables [AWS region](https://docs.aws.amazon.com/global-infrastructure/latest/regions/aws-regions.html) validation when passed 'true' 
  ...
  - name: main
    dag:
      ...
      - name: report-image-info
        templateRef:
          name: argo-hub.codefresh-csdp.1.1.24
